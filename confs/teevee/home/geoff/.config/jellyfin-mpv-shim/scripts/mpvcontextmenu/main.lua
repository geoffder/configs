...
local function  checkProfile(name)
    -- get current-profile custom variable and strip off quotes
    local p = string.sub(mp.get_property("user-data/current-profile"), 2, -2)
    return p == name
end
...
mp.register_event("file-loaded", function()
    menuList = {
        ...
        context_menu = {
            ...
            {SEP},
	    {CASCADE, "Profiles", "profiles_menu", "", "", false},
	...
	profiles_menu = {
		{RADIO, "AnimeHD", "", "apply-profile AnimeHD", function() return checkProfile("AnimeHD") end, false},
		{RADIO, "AnimeSD", "", "apply-profile AnimeSD", function() return checkProfile("AnimeSD") end, false},
		{RADIO, "IAmScum Anime4k", "", "apply-profile IAmScumAnime4K", function() return checkProfile("IAmScumAnime4K") end, false},
		{RADIO, "Kokomins Anime4k", "", "apply-profile KokominsAnime4K", function() return checkProfile("KokominsAnime4K") end, false},
		{RADIO, "Anime4K-A", "", "apply-profile Anime4K-A", function() return checkProfile("Anime4K-A") end, false},
		{RADIO, "Anime4K-B", "", "apply-profile Anime4K-B", function() return checkProfile("Anime4K-B") end, false},
		{RADIO, "Anime4K-C", "", "apply-profile Anime4K-C", function() return checkProfile("Anime4K-C") end, false},
		{RADIO, "Anime4K-A+A", "", "apply-profile Anime4K-A+A", function() return checkProfile("Anime4K-A+A") end, false},
		{RADIO, "Anime4K-B+B", "", "apply-profile Anime4K-B+B", function() return checkProfile("Anime4K-B+B") end, false},
		{RADIO, "Anime4K-C+A", "", "apply-profile Anime4K-C+A", function() return checkProfile("Anime4K-C+A") end, false},
		{RADIO, "AMD FSR EASU", "", "apply-profile AMD-FSR_EASU", function() return checkProfile("AMD-FSR_EASU") end, false},
